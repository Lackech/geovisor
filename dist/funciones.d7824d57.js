...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"funciones.js":[function(require,module,exports) {
function menu() {
...
col.addEventListener("click", menu); // Menucito 1

var op1 = window.document.getElementById("mostrar1");
op1.addEventListener("click", mostrar1); // Menucito 2

var op2 = window.document.getElementById("mostrar2");
op2.addEventListener("click", mostrar2); // Menucito 3

var op3 = window.document.getElementById("mostrar3");
op3.addEventListener("click", mostrar3); // Menucito 4

var op4 = window.document.getElementById("mostrar4");
op4.addEventListener("click", mostrar4); // Menucito 5

var op5 = window.document.getElementById("mostrar5");
op5.addEventListener("click", mostrar5); // Menucito 6

var op6 = window.document.getElementById("mostrar6");
op6.addEventListener("click", mostrar6); // Menucito 7

var op7 = window.document.getElementById("mostrar7");
op7.addEventListener("click", mostrar7); // Menucito 8
...
},{}]},{},["node_modules/parcel-bundler/src/builtins/hmr-runtime.js","funciones.js"], null)
//# sourceMappingURL=/funciones.d7824d57.js.map